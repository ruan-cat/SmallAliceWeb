...
>
> 二期 AI RAG 长任务已迁移至 OpenSpec 任务体系。本文件与 `docs/superpowers/specs/2026-07-29-ai-rag-phase2-design.md` 仅作历史参考，不再作为任务管理源。
>
> - 唯一任务源：`openspec/changes/ai-rag-phase2/tasks.md`（任务勾选状态以该文件为准）
