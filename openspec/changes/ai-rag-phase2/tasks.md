...
- [x] 2.3.1 [docs] `README.md` - 完善 AI 知识库作品说明
  ...
  - 2026-08-28 完成证据：根目录 README 已补齐动态同步、结构化 Chunk、Hybrid Search、流式问答、来源溯源、架构、技术栈、验证方式、已知边界和生产截图。

## 3. 里程碑

- [x] M1 最小 RAG 闭环
  - 标准：能从文档检索相关内容并回答，具有可复核 demo/运行证据。
  - 当前：生产 `/v1/search`、流式 `/v1/chat`、来源锚点跳转和 Chrome/CDP 证据已完成；不依赖早期学习草案。
...
- [x] M4 简历作品集
  - 标准：完整 README，包含可复核的生产验收截图与证据链接。
  - 当前：README 与生产证据截图已完成；30–60 秒视频录制和外部上传已由用户于 2026-08-28 明确取消。
